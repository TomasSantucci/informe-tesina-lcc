...
\begin{figure}[ht]
    ...
    \caption{Ventana local de keyframes y landmarks del VIO. A la izquierda, las imágenes de las cámaras con las observaciones de los landmarks. A la derecha, el mapa que contiene las poses de los keyframes y las posiciones de los landmarks de la ventana.}
