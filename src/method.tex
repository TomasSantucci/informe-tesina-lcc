...
% TODO: poner alguna figura para mostrar la idea de algunos de esos puntajes. de S_g y S_c
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{img/method/arch.full.pdf}
