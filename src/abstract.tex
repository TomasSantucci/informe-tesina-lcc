...
En este trabajo se presenta un sistema VI-SLAM eficiente, basado en el algoritmo de VIO de Basalt, que extiende Basalt-XR con detección y cierre de ciclos en tiempo real, optimización global de \textit{bundle adjustment} y culling de keyframes. La propuesta incorpora un módulo de \textit{loop closure} eficiente basado en HashBoW con arquitectura asíncrona, que corrige el drift global sin degradar el rendimiento del front-end, y adapta la formulación de RootBA para soportar configuraciones multicámara con modelos de cámara arbitrarios, proveyendo un bundle adjustment numéricamente estable y ejecutable con precisión simple.
...
% TODO: por qué "precisión simple" está mal?
