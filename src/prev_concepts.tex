...
\begin{figure}[!htbp]
    ...
    \end{subfigure}
    \caption{Pares de imágenes que ilustran el problema del perceptual aliasing. Cada uno de los tres pares muestra dos lugares distintos a pesar de tener una apariencia muy similar. Imagen extraída de~\cite{cummings2007probabilistic}.}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}[c]{0.54\textwidth}
        ...
        \captionof{figure}{Comparativa de precisión de métodos de visual place recognition. Imagen extraída de~\cite{hashbow2024stricker}.}
    ...
    \begin{minipage}[c]{0.42\textwidth}
        ...
        \begin{tabular}{lcc}
            ...
            \bottomrule
        \end{tabular}
        \captionof{table}{Comparativa de tiempos de procesamiento de métodos de visual place recognition. Tabla extraída de~\cite{hashbow2024stricker}.}
